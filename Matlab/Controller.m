        ...
        function [v1, v2, reach_target, obj] = update(obj, trans, rotation, target, targetTheta, obstacles)
            ...
            if((x_T - trans(1))^2 + (y_T - trans(2))^2  < 1e4)
                ...
                for i = 1:size(obstacles,1)
					...
					if r > obj.Predictive_Distance
						r = obj.Predictive_Distance;
					end
					if r < 0
						r = 0;
                    end
                    if r == 0
                        replusive_multiplier = 1;
                    else
                        replusive_multiplier = obj.Predictive_Distance / (obj.Predictive_Distance + obj.Predictive_Decay * r);
                    end
